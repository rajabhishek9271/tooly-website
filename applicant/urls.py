...
urlpatterns = [
    ...
    path('employer_detail1/', views.EmployerDetailsPage.as_view(),name='employer_detail1'),
    path('employer_detail2/', views.EmployerDetailsTwoPage.as_view(),name='employer_detail2'),
    ...
    path('job_detail1/', views.JobDetailsPage.as_view(),name='job_detail1'),
    path('job_detail2/', views.JobDetailsTwoPage.as_view(),name='job_detail2'),
    path('jobs_list/', views.JobListingPage.as_view(),name='jobs_list'),
    path('jobs_maps/', views.JobwithMapPage.as_view(),name='jobs_maps'),
    path('login_register/', views.LoginRegisterPage.as_view(),name='login_register'),
